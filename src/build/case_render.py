...
@media screen {
 :root[data-theme="dark"]{color-scheme:dark;--paper:#101e2a;--panel:#172a3a;--ink:#e7f2f9;--muted:#b2c8d8;--line:#39566b;--accent:#86cfee}
 :root[data-theme="dark"] .notice{background:#203c50}
 :root[data-theme="dark"] button[type=submit]{color:#101e2a}
}
...
(function () {
  ...
  try {
    var saved = localStorage.getItem("knee-ultrasound-course:theme");
...
<html lang="zh-Hant" data-theme="dark"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
